...
仓库地址：<https://github.com/MeepoKiki/vps-init>

脚本 Raw 地址：

```text
https://raw.githubusercontent.com/MeepoKiki/vps-init/main/vps-init.sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/MeepoKiki/vps-init/main/vps-init.sh -o /tmp/vps-init.sh && sudo bash /tmp/vps-init.sh
```

当前已经是 `root` 用户时：

```bash
curl -fsSL https://raw.githubusercontent.com/MeepoKiki/vps-init/main/vps-init.sh -o /tmp/vps-init.sh && bash /tmp/vps-init.sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/MeepoKiki/vps-init/main/vps-init.sh -o /tmp/vps-init.sh && sudo bash /tmp/vps-init.sh --dry-run
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/MeepoKiki/vps-init/main/vps-init.sh -o /tmp/vps-init.sh && sudo bash /tmp/vps-init.sh --yes --enable-firewall --enable-bbr
```

创建自动容量的 Swap 并安装 Docker：

```bash
curl -fsSL https://raw.githubusercontent.com/MeepoKiki/vps-init/main/vps-init.sh -o /tmp/vps-init.sh && sudo bash /tmp/vps-init.sh --yes --enable-swap --install-docker
```
...
```text
https://raw.githubusercontent.com/MeepoKiki/vps-init/v1.0.0/vps-init.sh
```
